...
function validerRuteInput() {
	...
	const tilleggPerStopp = validerTilleggPerStopp(
		$("#tilleggPerStopp"),
		"#feilTilleggPerStopp"
	);
...
function validerRuteStoppInput() {
	...
	const minutterTilNesteStopp = validerMinutterTilNesteStopp(
		$("#minutterTilNesteStopp"),
		"#feilMinutterTilNesteStopp"
	);
...
function validerStoppnavn(innElmt, utId) {
	...
	let ok = false;
	if (testRegex(innElmt, regex) && stoppFins) {
		ok = true;
	}
